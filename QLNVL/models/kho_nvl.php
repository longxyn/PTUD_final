...
class kho_nvl{
    ...
    static function filterByStatus($status, $start, $recordsPerPage) {
        ...
        $query = 'SELECT kn.id_kho_nvl, kn.ten_kho_nvl, kn.dia_chi, db.Id, db.NgayBan, nv.TaiKhoan, kh.TenKH, db.Tong, db.TrangThai 
        FROM DonBan db 
        JOIN kho_nvl kn ON kn.id_kho_nvl = db.id_kho_nvl
