<?php
        ...
        $reg2 = $db2->query('select * from sp');
        foreach ($reg2->fetchAll() as $item){
            $list2[] =new sp($item['Id'],$item['TenSP'],$item['IdDVT'],$item['IdNCC'],$item['SoLuong'],$item['TrangThai'],$item['id_kho_sp']);
                        }
        $data2 =array('sanpham'=> $list2);
        //
        $list3 = [];
...
if(isset($_POST['create-sp'])){
    ...
    $ksp = $_POST["ksp"];
    sp::add($id,$ten,$dvt,$ncc,$soluong,$TrangThai,$ksp);
}
?>
