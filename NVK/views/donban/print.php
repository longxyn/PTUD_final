...
$list1 =[];
$db1 =DB::getInstance();
$reg1 = $db1->query('SELECT ct.Id ,db.Id As "Don",sp.TenSP ,dvt.DonVi  ,ct.SoLuong  FROM ChiTietBan ct JOIN DonViTinh dvt JOIN DonBan db JOIN SanPham sp ON ct.IdDonBan = db.Id AND ct.IdSP = sp.Id AND sp.IdDVT = dvt.Id WHERE ct.IdDonBan='.$donban->Id);
foreach ($reg1->fetchAll() as $item){
    $list1[] =new ChiTietBan($item['Id'],$item['Don'],$item['TenSP'],$item['DonVi'],$item['SoLuong']);
}
    ...
    <section class="sheet padding-10mm" style="padding-left: 10px;padding-right: 10px">
        ...
        <table border="0" width="100%" cellspacing="0">
            ...
            <tr>
                ...
                <td align="center">
                    <b style="font-size: 2em;">Flexers Team</b><br />
