...
<form method="post" name="create-kh">
    <div class="form-group ml-5">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="email" class="form-control" id="validationDefault02" name="email" placeholder="Nhập Email(abc@gmail.com)..." required>
        </div>
        <div class="col-md-4 mb-3">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" id="validationDefault02"name="taikhoan" placeholder="Nhập Tài khoản(Tên.Flexers)..." required>
        </div>
        <div class="col-md-4 mb-3">
