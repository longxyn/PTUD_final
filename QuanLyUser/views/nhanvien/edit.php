...
<form method="post" name="edit-kh">
    <div class="form-group ml-5">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="email" class="form-control" id="validationDefault02" value="<?= $nhanvien->Email ?> " name="email" placeholder="Nhập Email(abc@gmail.com)..." required>
        </div>
        <div class="col-md-4 mb-3">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" id="validationDefault02" value="<?= $nhanvien->TaiKhoan ?> " name="taikhoan" placeholder="Nhập Tài khoản(Tên.Flexers)..."  readonly  required>
        </div>
        <div class="col-md-4 mb-3">
        ...
        <div class="col-md-4 mb-3">
            <label for="validationDefault02">Trạng thái hoạt động</label>
