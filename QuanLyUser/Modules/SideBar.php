    ...
    <li class="nav-item">
        ...
        <div id="collapseNV" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="?controller=nhanvien">Danh sách nhân viên</a>
                <a class="collapse-item" href="?controller=nhanvien&action=insert">Thêm tài khoản</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapsequyen" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="?controller=phanquyen&action=insert">Cấp quyền</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
